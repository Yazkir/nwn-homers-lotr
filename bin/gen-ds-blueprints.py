...
MAPPED = [
    ...
    # Servants of Sauron
    ("ds_thehighmageofbar", "thehighmageofbar",  "DS Gothmog the Burning",    None),
    ("ds_hoarmouththering", "hoarmouththering",  "DS Drowned Mouth of Sauron",None),
    ("ds_creature023",      "creature023",       "DS Khamul the Easterling",  None),
    ("ds_adunaphelther001", "adunaphelther001",  "DS Adunaphel the Quiet",    None),
    ("ds_angmartheevoocat", "angmartheevoocat",  "DS Witch-king of Angmar",   None),
    # Orcs of Mordor
    ...
    ("ds_urukhaifirstborn", "urukhaifirstborn",  "DS Mauhur",                 None),
    ...
    # Rohan
    ("ds_eowyntheshieldma", "eowyntheshieldma",  "DS Eowyn Shieldmaiden",     None),
    # Rangers of the North
    ("ds_rangerofthe003",   "rangerofthe003",    "DS Halbarad",               None),
    ...
    ("ds_bearbeorning001",  "bearbeorning001",   "DS Silvan Shapeshifter",    None),
    ("ds_mirkwoodforestwa", "mirkwoodforestwa",  "DS Mirkwood Shade",         None),
    ("ds_creature018",      "creature018",       "DS Thranduil's Scout",      None),
    ("ds_legolasgreenl001", "legolasgreenl001",  "DS Legolas Greenleaf",      None),
    # Fellowship / Gondor
    ("ds_aragornsonofarat", "aragornsonofarat",  "DS Aragorn Strider",        None),
    ...
    ("ds_gondorianguar002", "gondorianguar002",  "DS Beregond",               None),
    ("ds_gimli",            "gimli",             "DS Gimli Son of Gloin",     None),
    ("ds_galadriel",        "galadriel",         "DS Galadriel",              None),
    ("ds_sarumanthewhi001", "sarumanthewhi001",  "DS Saruman the White",      None),
]
